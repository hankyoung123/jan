    ...
    return (
      <StoryPage>
        ...
        <section className="border bg-background p-8">
          ...
          <Button className="mt-5" onClick={() => void loadProject()} variant="outline">

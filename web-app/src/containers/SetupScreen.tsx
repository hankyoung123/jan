          ...
          <div className="shrink-0 px-10 w-[480px] mx-auto overflow-auto pb-10 pointer-events-auto -mt-20">
            <div className="mb-4">
              <h1 className="font-studio font-medium text-2xl mb-1">
                {isDownloading
                  ? 'Sit tight, Story Engine is getting ready...'
                  : 'Welcome to Story Engine'}
              </h1>
              <p className='text-muted-foreground leading-normal w-full mt-1'>
                {isDownloading
                  ? 'This may take a few minutes.'
                  : 'Story Engine needs a model to begin. Let’s set it up.'}
              </p>
            </div>
                    ...
                    <div className="flex flex-col w-full h-full justify-center">
                      <div className="flex flex-1 items-center justify-between">
                        <h1 className="font-semibold text-sm mb-1">
                          <span>
                            {janNewModel?.display_name ??
                              janNewModel?.model_name ??
                              'Recommended local model'}
                          </span>&nbsp;<span className='text-xs text-muted-foreground'>· {defaultVariant?.file_size}</span>
                        </h1>
                        {(isDownloading) && (
